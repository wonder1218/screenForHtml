...
new Vue({
    ...
    created() {
        ...
        this.pieData3DCopy = [
            { value: this.data3D.red, percent: this.data3D.redPercent, name: '公司金融服务部', itemStyle: { color: '#F3410A', opacity: 1 } },
            { value: this.data3D.yellow, percent: this.data3D.yellowPercent, name: '普惠及乡村振兴金融服务部', itemStyle: { color: '#FFCF37', opacity: 1 } },
            { value: this.data3D.blue, percent: this.data3D.bluePercent, name: '零售羚信货部', itemStyle: { color: '#065DFF', opacity: 1 } },
        ];
